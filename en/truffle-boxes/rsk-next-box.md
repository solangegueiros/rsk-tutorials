# Using Truffle box rsk-next-box

How to install and use a Truffle box that comes with Next JS, and works with the RSK network.
...
![truffle test](../../images/rsk-next-box/image-04.png)
...
![simpleStorage.json networks](../../images/rsk-next-box/image-05.png)
...
![simpleStorage.json abi](../../images/rsk-next-box/image-06.png)
...
![simpleStorage set](../../images/rsk-next-box/image-07.png)
...
![npm run dev](../../images/rsk-next-box/image-08.png)

Then go to your browser at [http://localhost:3000/](http://localhost:3000/)

![localhost port 3000](../../images/rsk-next-box/image-09.png)
...
![minimum gas price testnet](../../images/rsk-next-box/image-10.png)
...
![A_MNEMONIC](../../images/rsk-next-box/image-11.png)
...
![accounts](../../images/rsk-next-box/image-12.png)
...
![faucet.testnet.rsk.co](../../images/rsk-next-box/image-13.png)

Enter your wallet address and pass the CAPTCHA.

Wait a few seconds…

![wait faucet](../../images/rsk-next-box/image-14.png)
...
![faucet Received some R-BTCs](../../images/rsk-next-box/image-15.png)
